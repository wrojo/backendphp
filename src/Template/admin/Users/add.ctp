...
<div class="card">
   ...
   <div class="card-body">
      ...
      <div class="form-group">
         ...
         <?php echo $this->Form->control('password', ['type'=>'password','class'=>'form-control','label'=>false]); ?>
      </div>
      <div class="form-group">
         <label><?= __('Rol')?></label>
      ...
      <?= $this->Form->button(__('Crear usuario'),['class'=>'btn btn-primary mr-2','type' => 'submit']) ?>
   </div>
   <?= $this->Form->end() ?>
</div>
